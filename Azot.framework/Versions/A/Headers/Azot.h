 ...
 *  @return void
 */
+ (void)start:(nonnull NSString*)azotAppToken;
 ...
 *  @return void
 */
+ (void)startPage:(nonnull NSString*)pageId;
 ...
 *  @return void
 */
+ (void)stopPage:(nonnull NSString*)pageId;
 ...
 *  @return void
 */
+ (void)feedback:(nonnull NSString *)message forCategory:(nonnull NSString *)category;
 ...
 *  @return void
 */
void azotLogger(NSString * _Nonnull format, ...);
...
@property (strong, nonnull)  ASVideoParams*      video;
@property (strong, nonnull)  ASFeedbackParam*    feedbackParams;

@end

@protocol AzotSecureProtocol
@required
